...
# Compare methylation between diploids and triploids

```{r}
diploidTriploidAverages <- read.delim("/Volumes/web/spartina/project-oyster-oa/Haws/methylation-landscape/ploidy-methylation-averages.bedgraph", sep = "\t", header = FALSE, col.names = c("diploidMeth", "triploidMeth")) #Import average methylation in diploids and triploids and assign column names
head(diploidTriploidAverages) #Confirm file import
```
