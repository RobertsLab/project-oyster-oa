...
DMLbarplot <- barplot(as.matrix(t(DMLchrCounts)),
                      ...
                      ylim = c(0,10e-5),
                      cex.names = 1.5,
                      col = c(plotColors[4], plotColors[6], "white")) #Create a barplot and save as a new object. Use axes = FALSE to remove the y-axis and names.arg to set labels on the x-axis. The object contains x coordinates for bars, so xlim is set at 11.5
...
legend("bottomright", xpd = TRUE, inset = c(0, 0), 
       ...
       pch = c(22, 22, 22), 
        col = "black",
        pt.bg = c(plotColors[4], plotColors[6], "white")) #Add a legend with information about DML list
