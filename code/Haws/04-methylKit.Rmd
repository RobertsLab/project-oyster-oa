...
```{r}
processedFilteredFilesCov5T <- methylKit::reorganize(processedFiles,
                                                     sample.id = list("2H-1", "2H-2", "2H-3", "2H-4", "2H-5", "2H-6",
                                                                      "2L-1", "2L-2", "2L-3", "2L-4", "2L-5", "2L-6",
                                                                      "3H-1", "3H-2", "3H-3", "3H-4", "3H-5", "3H-6",
                                                                      "3L-1", "3L-2", "3L-3", "3L-4", "3L-5", "3L-6"),
  ...
  methylKit::filterByCoverage(.,
                              lo.count = 5, lo.perc = NULL,
                              high.count = NULL, high.perc = 99.9) %>% 
  methylKit::normalizeCoverage(.) #Reorganize processedFiles to provide treatment specification. Filter by coverage and normalize coverage between samples
```
