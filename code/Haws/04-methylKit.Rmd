...
sessionInfo()
```
# Import information from existing .RData file

This step is used to avoid repeating the computationally intensive `methylKit` steps below.

```{r}
attach("methylKit.RData") #Attach methylKit RData

processedFiles <- processedFiles #Save files with minimum coverage = 2
processedFilteredFilesCov5 <- processedFilteredFilesCov5 #Save data for minimum coverage = 5
methylationInformationFilteredCov5 <- methylationInformationFilteredCov5 #Save transposed data used for PLSDA

detach("file:methylKit.RData") #Detach methylKit RData
```
