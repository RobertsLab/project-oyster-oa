...
differentialMethylationStatsPloidyCovar <- methylKit::calculateDiffMeth(methylationInformationFilteredCov5,
                                                                   ...
                                                                   mc.cores = 2) #Calculate differential methylation statistics based on treatment indication from methRead. Include pH as a covariate by converting column with pH informatoin into a dataframe. Use 40 cores.
...
differentialMethylationStatsPloidy <- methylKit::calculateDiffMeth(methylationInformationFilteredCov5,
                                                                   overdispersion = "MN", test = "Chisq",
                                                                   mc.cores = 40) #Calculate differential methylation statistics based on treatment indication from methRead. Include pH as a covariate by converting column with pH informatoin into a dataframe. Use 40 cores.
