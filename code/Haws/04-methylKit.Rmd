...
```{r}
diffMethStatsPloidy50 <- mmgetMethylDiff(differentialMethylationStatsPloidy, difference = 50, qvalue = 0.01) #Identify loci that are at least 50% different
length(diffMethStatsPloidy50) #Count the number of DML
