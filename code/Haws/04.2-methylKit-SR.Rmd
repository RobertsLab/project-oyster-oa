...
<!-- ```{bash} 
mv *.merged_CpG_evidence.cov ../../analyses/Haws_04-methylKit #Move -->
<!-- files from current directory to analyses folder 
``` -->
...
```{r}
#write.csv(diffMethStatsPloidy50Hyper, "../../analyses/Haws_04-methylKit/DML-ploidy-50-Cov5-Hyper.csv") #Save table as .csv
```
...
```{r}
#write.csv(diffMethStatsPloidy50Hypo, "../../analyses/Haws_04-methylKit/DML-ploidy-50-Cov5-Hypo.csv") #Save table as .csv
```
...
```{r}
#write.csv(diffMethStatsTreatment50Hyper, "../../analyses/Haws_04-methylKit/DML-pH-50-Cov5-Hyper.csv") #Save table as .csv
```
...
```{r}
#write.csv(diffMethStatsTreatment50Hypo, "../../analyses/Haws_04-methylKit/DML-pH-50-Cov5-Hypo.csv") #Save table as .csv
```
...
*THE CODE BELOW HAS NOT BEEN UPDATED*
