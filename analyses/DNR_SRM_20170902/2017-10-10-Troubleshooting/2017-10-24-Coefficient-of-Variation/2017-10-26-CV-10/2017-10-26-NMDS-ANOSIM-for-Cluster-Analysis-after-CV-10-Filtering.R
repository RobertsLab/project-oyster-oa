...
max(SRMModifiedAreas$CoV) <= 10 #Statement should be TRUE if maximum does not exceed 10
...
#jpeg(filename = "2017-10-10-Troubleshooting/2017-10-24-Coefficient-of-Variation/2017-10-26-CV-10//2017-10-26-NMDS-Norm-Analysis-Averaged-after-CV10-Filtering.jpeg", width = 1000, height = 1000)
