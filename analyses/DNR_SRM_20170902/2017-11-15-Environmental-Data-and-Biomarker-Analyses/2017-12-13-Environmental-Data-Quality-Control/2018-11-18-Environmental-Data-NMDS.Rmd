...
ordihull(envData.log.gower.NMDS, plotCustomization$Parameter, show.groups = "M", col = "grey80", lty = 1) #Add confidence ellipse around the data from means
ordihull(envData.log.gower.NMDS, plotCustomization$Parameter, show.groups = "V", col = "grey80", lty = 2) #Add confidence ellipse around the data from means
```
